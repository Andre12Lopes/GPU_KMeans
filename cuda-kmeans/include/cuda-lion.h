...
inline int
__syncthreads_count(int predicate){return predicate};
inline int
__syncthreads_and(int predicate){return predicate};
inline int
__syncthreads_or(int predicate){return predicate};
inline int
...
template <class T>
inline T
__ldg(const T *address){return *address};
// CUDA TYPES
